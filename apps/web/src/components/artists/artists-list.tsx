...
export function ArtistsList() {
  ...
  const [form, setForm] = useState({ firstName: '', lastName: '', email: '', phone: '', specialties: '' });
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setShowForm(false);
      setForm({ firstName: '', lastName: '', email: '', phone: '', specialties: '' });
    },
  });
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="sm:col-span-2">
              <input
                placeholder="Especialidades (ex: Blackwork, Realismo, Old School)"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wide hidden md:table-cell">Especialidades</th>
