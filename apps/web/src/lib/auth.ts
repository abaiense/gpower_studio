...
// TODO: Before go-live, migrate to httpOnly cookies via backend Set-Cookie endpoint
// Current implementation is vulnerable to XSS as tokens are accessible via document.cookie
